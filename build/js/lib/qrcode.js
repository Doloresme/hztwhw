...
$.fn.qrcode = function (options) {
  ...
  var createTable = function createTable() {
    ...
    var $table = $('<table class="qrcode-img"></table>').css("width", options.width + "px").css("height", options.height + "px").css("border", "0px").css("border-collapse", "collapse").css('background-color', options.background); // compute tileS percentage
