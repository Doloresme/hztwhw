(function () {
  ...
  Slider.prototype.domOperation = function () {
    ...
    if (this.isImg) {
      for (var i = 0; i < this.len; i++) {
        str += '<li style="background:url(\'' + this.image[i] + '\') no-repeat center">' + '</li>';
      }
    ...
    if (sliderIndex) {
      for (var _i2 = 0; _i2 < this.len; _i2++) {
        if (_i2 == 0) {
          spanStr += '<span class="active" data-index="' + _i2 + '"></span>';
        } else {
          spanStr += '<span data-index="' + _i2 + '"></span>';
        }
      }
  ...
  Slider.prototype.startMove = function (dir) {
    ...
    function move(that) {
      that.timer = setInterval(function () {
        ...
        iSpeed = (that.w * that.index + iCur) / 8; // console.log(iCur, iSpeed);
  ...
  Slider.prototype.changeActive = function (index) {
    ...
    for (var i = 0; i < sliderLiArr.length; i++) {
  ...
  Slider.prototype.changeIndexActive = function (index) {
    ...
    for (var i = 0; i < indexSpanArr.length; i++) {
